module.exports = {
  ...
  (fp_text user "C6" (at 1.5 10.6 ${p.rot} unlocked) (layer "${p.side}.SilkS")
    (effects (font (size 1 1) (thickness 0.15))))
  (fp_text user "R2" (at -3 10.8 ${p.rot} unlocked) (layer "${p.side}.SilkS")
    (effects (font (size 1 1) (thickness 0.15))))
  (fp_text user "R0" (at 0 10.8 ${p.rot} unlocked) (layer "${p.side}.SilkS")
    (effects (font (size 1 1) (thickness 0.15))))
  (fp_text user "C5" (at 3 10.6 ${p.rot} unlocked) (layer "${p.side}.SilkS")
    (effects (font (size 1 1) (thickness 0.15))))
  (fp_text user "R1" (at -1.5 10.8 ${p.rot} unlocked) (layer "${p.side}.SilkS")
    (effects (font (size 1 1) (thickness 0.15))))  
...
`
      ...
      (property "Sheetname" "")
      (attr smd)
      (fp_text reference "J1" (at 0 -3.98) (layer "${p.side}.Fab") (effects (font (size 1 1) (thickness 0.15))))      
      
      (fp_text user "Col5" (at 3 10.8 -90 unlocked) (layer "${p.side}.Fab") (effects (font (size 1 1) (thickness 0.15))))
      (fp_text user "Col6" (at 1.5 10.8 -90 unlocked) (layer "${p.side}.Fab") (effects (font (size 1 1) (thickness 0.15))))
      (fp_text user "Row0" (at 0 10.8 -90 unlocked) (layer "${p.side}.Fab") (effects (font (size 1 1) (thickness 0.15))))
      (fp_text user "Row1" (at -1.5 10.8 -90 unlocked) (layer "${p.side}.Fab") (effects (font (size 1 1) (thickness 0.15))))      
      (fp_text user "Row2" (at -3 10.8 -90 unlocked) (layer "${p.side}.Fab") (effects (font (size 1 1) (thickness 0.15))))
      ...
      (fp_line (start 3.5 -2.575) (end -3.5 -2.575) (layer "${p.side}.Fab") (width 0.1) )
      (fp_line (start -3.5 1.675) (end -3.5 -2.575) (layer "${p.side}.Fab") (width 0.1) )
      (pad "1" smd roundrect (at 2 2 180) (size 0.6 1.55) (layers "${p.side}.Cu" "${p.side}.Paste" "${p.side}.Mask") (roundrect_rratio 0.25) ${p.C5.str})
      (pad "2" smd roundrect (at 1 2 180) (size 0.6 1.55) (layers "${p.side}.Cu" "${p.side}.Paste" "${p.side}.Mask") (roundrect_rratio 0.25) ${p.C6.str})
      (pad "3" smd roundrect (at 0 2 180) (size 0.6 1.55) (layers "${p.side}.Cu" "${p.side}.Paste" "${p.side}.Mask") (roundrect_rratio 0.25) ${p.R0.str})
      (pad "4" smd roundrect (at -1 2 180) (size 0.6 1.55) (layers "${p.side}.Cu" "${p.side}.Paste" "${p.side}.Mask") (roundrect_rratio 0.25) ${p.R1.str})
      (pad "5" smd roundrect (at -2 2 180) (size 0.6 1.55) (layers "${p.side}.Cu" "${p.side}.Paste" "${p.side}.Mask") (roundrect_rratio 0.25) ${p.R2.str})
      (pad "MP" smd roundrect (at -3.3 -1.875 180) (size 1.2 1.8) (layers "${p.side}.Cu" "${p.side}.Paste" "${p.side}.Mask") (roundrect_rratio 0.208333) )
      (pad "MP" smd roundrect (at 3.3 -1.875 180) (size 1.2 1.8) (layers "${p.side}.Cu" "${p.side}.Paste" "${p.side}.Mask") (roundrect_rratio 0.208333) )
      (model "\${KICAD6_3DMODEL_DIR}/Connector_JST.3dshapes/JST_SH_SM05B-SRSS-TB_1x05-1MP_P1.00mm_Horizontal.wrl"
