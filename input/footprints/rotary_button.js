...
module.exports = {
    ...
    body: p => `
        (module rotary_encoder (layer F.Cu) (tedit 603326DE)
            ...
            (pad "" thru_hole circle (at 0 5.5 ) (size 2.7018 2.7018) (drill 1.7018) (layers *.Cu *.Mask))            
            (pad "" thru_hole circle (at 0 -5.5 ) (size 2.7018 2.7018) (drill 1.7018) (layers *.Cu *.Mask))
            
            ${''/* pins */}
            (pad 1 thru_hole circle (at 3.8 5 ) (size 2.032 2.032) (drill 1.27) (layers *.Cu *.Mask) ${p.to.str})
            (pad 2 thru_hole circle (at 5.9 0 ) (size 2.032 2.032) (drill 1.27) (layers *.Cu *.Mask) ${p.from.str})
        )
    `
}
