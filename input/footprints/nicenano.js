  ...
  body: p => {
    ...
    function pins(def_neg, def_pos) {
      return `
        ...
        (fp_text user C4 (at 6.35 ${def_pos}5.7 ${p.rot + 90}) (layer F.Fab) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user C5 (at 8.89 ${def_pos}5.7 ${p.rot + 90}) (layer F.Fab) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user C6 (at 11.43 ${def_pos}5.7 ${p.rot + 90}) (layer F.Fab) (effects (font (size 0.8 0.8) (thickness 0.15))))
        ...
        (fp_text user C4 (at 6.35 ${def_pos}5.7 ${p.rot + 90}) (layer B.Fab) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user C5 (at 8.89 ${def_pos}5.7 ${p.rot + 90}) (layer B.Fab) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user C6 (at 11.43 ${def_pos}5.7 ${p.rot + 90}) (layer B.Fab) (effects (font (size 0.8 0.8) (thickness 0.15))))
        ...
        (fp_text user RO2 (at -3.81 ${def_neg}5.3 ${p.rot + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user RO3 (at -1.27 ${def_neg}5.3 ${p.rot + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))

        (fp_text user RO2 (at -3.81 ${def_neg}5.3 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user RO3 (at -1.27 ${def_neg}5.3 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        ...
        (fp_text user R2 (at 6.35 ${def_neg}5.7 ${p.rot + 90}) (layer F.Fab) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user R3 (at 8.89 ${def_neg}5.3 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        ...
        (fp_text user R2 (at 6.35 ${def_neg}5.7 ${p.rot + 90}) (layer B.Fab) (effects (font (size 0.8 0.8) (thickness 0.15))))                
        (fp_text user R3 (at 8.89 ${def_neg}5.3 ${p.rot + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        ...
        (pad 22 thru_hole circle (at 8.89 ${def_neg}7.62 0) (size 1.7526 1.7526) (drill 1.0922) (layers *.Cu *.Fab *.Mask) ${p.R3.str})
