module.exports = {
    ...
    (fp_poly
      ...
      (stroke (width 0) (type solid)) (fill solid) (layer "Cmts.User") )
    (pad "1" smd rect (at -2.54 -1.2 ${p.rot}) (size 1 1.6) (layers "B.Cu" "B.Paste" "B.Mask")  ${p.one.str} )
    (pad "2" smd rect (at 0 -1.2 ${p.rot}) (size 1 1.6) (layers "B.Cu" "B.Paste" "B.Mask")  ${p.two.str})
    (pad "3" smd rect (at 2.54 -1.2 ${p.rot}) (size 1 1.6) (layers "B.Cu" "B.Paste" "B.Mask")  ${p.three.str})
    (pad "5" smd rect (at -2.54 1.2 ${p.rot}) (size 1 1.6) (layers "B.Cu" "B.Paste" "B.Mask")  ${p.one.str} )
    (pad "6" smd rect (at 0 1.2 ${p.rot}) (size 1 1.6) (layers "B.Cu" "B.Paste" "B.Mask")  ${p.two.str})
    (pad "7" smd rect (at 2.54 1.2 ${p.rot}) (size 1 1.6) (layers "B.Cu" "B.Paste" "B.Mask")  ${p.three.str})
  )
